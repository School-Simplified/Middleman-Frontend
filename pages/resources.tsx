...
const ResourceItem = ({ children, Name, link }: {children:any; Name:string; link:string}) => {
    return (
      <div className="flex border-blue-600 border-2 rounded-xl items-center w-full hover:shadow-xl py-5 rounded-xl px-5 mt-3 cursor-pointer"
      ...
      <div className="w-full flex">
        ...
        <div>
            <ResourceItem 
                ...
                children={<img src={SchoolSimpLogoBlue.src} height="70" width="70"/>} 
            />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
            <ResourceItem 
                ...
                children={<img className="rounded-full" src={SchoolSimpDiscordIcon.src} height="70" width="70"/>} 
            />
            <ResourceItem 
                Name="Staff Resources & Information" 
                link="https://discord.gg/aWsdY4fqxj" 
                children={<img className="rounded-full" src={StaffResourcesIcon.src} height="70" width="70"/>} 
            />
            <ResourceItem 
                Name="School Simplified Staff Community" 
                link="https://discord.gg/VsdU7qV2vS" 
                children={<img className="rounded-full" src={StaffCommunityIcon.src} height="70" width="70"/>} 
            />
        </div>
